...
func NewLogger(prefix string) *Logger {
	...
	return &Logger{
		debug:   log.New(writer, logger.Prefix()+" "+"DEBUG: ", logger.Flags()),
		info:    log.New(writer, logger.Prefix()+" "+"INFO: ", logger.Flags()),
		warning: log.New(writer, logger.Prefix()+" "+"WARNING: ", logger.Flags()),
		err:     log.New(writer, logger.Prefix()+" "+"ERROR: ", logger.Flags()),
		writer:  writer,
	}
}
